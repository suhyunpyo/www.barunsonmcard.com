...
gallery_elem += "<a href=\"javascript:;\" class=\"crop ico\"></a>";
gallery_elem += "<a href=\"javascript:;\" class=\"move ico ui-sortable-handle\"></a>";
gallery_elem += "<a href=\"javascript:;\" class=\"delete ico\"></a>";
gallery_elem += "</div ></li > ";
...
function addUploadError() {
    var msg = "";
    if (cntErrorCount > 0) {
        msg = "<p>업로드수가 초과되어 등록되지 않았습니다 (" + cntErrorCount + "건)</p>";
    }
    if (cntErrorSize > 0) {
        msg += "<p>용량이 초과되어 등록되지 않았습니다 (" + cntErrorSize + "건)</p>";
    }
    if (cntErrorType > 0) {
