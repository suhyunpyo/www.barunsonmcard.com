	 ...
	 */
     function goStartMode(){
    	 ...
    	 if(sSrc.indexOf("btn_confirm2.png") < 0 ){
    		 welBtnConfirm.attr("src","/img/editor/btn_confirm2.png");
     ...
     function goReadyMode(){
    	 ...
    	 if(sSrc.indexOf("btn_confirm2.png") >= 0 ){
             ...
             welBtnConfirm.attr("src","/img/editor/btn_confirm.png");
    	 }
     }   
    ...
    function addImage(ofile){
		...
		if( !!bExceedLimitTotalSize ){
            ...
            aFileList.push('	<a onclick="delImage(\'img' + nImageInfoCnt +'\')"><img class="del_button" src="/img/editor/btn_del.png"  width="14" height="13" alt="첨부 사진 삭제"></a>');
			aFileList.push('	</li> ');   
    ...
    /*   sUploadURL = '/Common/fileUpload/SE2ImageUpload';*/
        sUploadURL = '/Admin/FileUpload/ImageUpload';
    	//파일을 하나씩 보내고, 결과를 받음.
    ...
    function callAjaxForHTML5(tempFile, sUploadURL) {
        ...
        //alert(sUploadURL);
        //jindo.$Fn(onAjaxError111, this).bind()
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
            ...
            sUrl: '/Board/Notice/SE2ImageUpload',	//샘플 URL입니다.
